...
const FALLBACK_PROVIDERS: Record<string, CatalogProviderDef> = {
  ...
  kimi:        { id: "kimi",        name: "Kimi",               tag: "国内",                  tagEn: "China",             keyLabel: "Kimi API Key",        keyPlaceholder: "sk-...", defaultModel: "", hasBaseUrl: true, defaultBaseUrl: "https://api.moonshot.cn/v1", defaultUserAgent: "rsclaw/2026.8.28" },

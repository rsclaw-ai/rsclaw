...
const en: LocaleType = {
  ...
  Auth: {
    ...
    TopTips:
      "RsClaw Multi-Agent AI Engine - route to any model through a single endpoint",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    Input: (submitKey: string) => {
      ...
      return inputHints + ", / for commands";
    },
    Send: "Send",
    ...
    Config: {
      ...
      Topic: {
        Title: "Topic",
        SubTitle: "Set the topic for this conversation",
      },
    },
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "",
        SubTitle:
          "RsClaw Multi-Agent AI Engine - unified access to all models",
        ChatNow: "Start Now",
      },
      AccessCode: {
        Title: "Access Code",
  ...
  RsClawSettings: {
    ...
    GatewayUrlSub: "RsClaw gateway endpoint",
    AuthToken: "Auth Token",
    AuthTokenSub: "Bearer token for gateway authentication",
    Agent: "Agent",
    AgentSub: "Select the agent for chat",
    AgentDefault: "default",
  ...
  GatewayControl: {
    ...
    SubTitle: "Manage your rsclaw gateway",
    Checking: "Checking...",
    ...
    StartToSee: "Start the gateway to see agents",
  },

  RsClawPanel: {
    Splash: "Welcome to RsClaw Multi-Agent AI Engine!",
    ...
    Status: {
      ...
      StopSub: "All channels will disconnect and active sessions will be terminated.",
      StopNote: "Users will not be able to send messages until the gateway is restarted.",
      StopConfirm: "Confirm Stop",
      Stopping: "Stopping",
      RestartTitle: "Restart Gateway",
      RestartSub: "Gateway will briefly interrupt then auto-recover. Channels and config will reload.",
      RestartNote: "All channels will be unavailable for ~2-5 seconds during restart.",
      RestartConfirm: "Confirm Restart",
      Restarting: "Restarting",
      StartTitle: "Start Gateway",
      StartSub: "Gateway will start and auto-connect all configured channels.",
      StartNote: "First startup may take a few seconds to initialize channel connections.",
      StartConfirm: "Confirm Start",
      Starting: "Starting",
      CurrentStatus: "Current Status",
      ChannelCount: "Connected Channels",
      ...
      Memory: "Memory",
      SingleProcess: "Rust single process",
      None: "none",
      MessageChannels: "Message Channels",
      NoChannels: "No channels configured",
      StartGateway: "Start the gateway to see channels",
    ...
    Config: {
      ...
      SaveSuccess: "Config saved and reloaded",
      SaveFailed: "Failed to save: ",
      Gateway: "Gateway",
      Port: "port",
      Bind: "bind",
      BindLoopback: "loopback (local only)",
      ...
      ReloadNote: "Hot reload is triggered after save. Note: changes to agents, channels, and other core settings require a gateway restart to take effect.",
    },

    Agents: {
      PageTitle: "Agent Manager",
      PageSub: "agents.list -- configure model and channel bindings per agent",
      NewAgent: "+ New Agent",
      AgentNote: "agents.defaults compaction and model settings apply to all agents; individual overrides are supported.",
      NoAgents: "No agents configured. Click \"+ New Agent\" to add one.",
      Edit: "Edit",
      Delete: "Delete",
      ...
      AgentNamePlaceholder: "Display name, e.g. Sales Assistant",
      Avatar: "Avatar",
      AvatarHint: "Click to pick an emoji avatar",
      Model: "Model",
      ChannelsInput: "Channels (comma-separated)",
      ToolsetInput: "Toolset (comma-separated)",
      Cancel: "Cancel",
      Create: "Create",
      Update: "Update",
      ...
      TemplateApplied: "Template applied to workspace",
      DeleteFailed: "Failed to delete agent: ",
    },

    Workspace: {
      PageTitle: "Workspace Files",
      PageSub: "Edit agent system prompts and configuration files",
      ...
      Create: "Create",
      Cancel: "Cancel",
      EditorPlaceholder: "Select a file from the left to start editing...",
      NavTitle: "Workspace",
    },

    Doctor: {
      PageTitle: "Health Check",
      PageSub: "Diagnose configuration issues and auto-fix",
      NavTitle: "Health Check",
      RunCheck: "Check",
      RunFix: "Fix",
      Running: "Checking...",
      Fixing: "Fixing...",
      NoIssues: "All checks passed, no issues found.",
    ...
    Wizard: {
      ...
      DetectTitle: "Detect Environment",
      DetectSub: "Check for existing OpenClaw installation to migrate.",
      DetectChecking: "Detecting...",
      DetectFound: "OpenClaw installation detected",
      DetectNotFound: "No OpenClaw installation found. Starting fresh setup.",
      DetectPath: "Path",
      MigrateBtn: "Migrate Data",
      MigrateSkip: "Skip, fresh install",
      Migrating: "Migrating...",
      MigrateDone: "Migration complete",
      MigrateFailed: "Migration failed",

      Step1Title: "Select Language",
      Step1Sub: "Choose the primary language for rsclaw system prompts and responses.",

      Step2Title: "Choose LLM Provider",
      Step2Sub: "Select model providers and enter API keys. Multi-select supported; rsclaw auto-failovers.",

      Step3Title: "Connect Channels",
      Step3Sub: "Choose messaging platforms to connect. Select at least one; more can be added later.",
      WechatScanQR: "Scan QR to login WeChat",
      WechatScanning: "Waiting for scan...",
      WechatConnected: "WeChat connected",
      WechatExpired: "QR expired, please retry",
      FeishuAppId: "Feishu App ID",
      FeishuAppSecret: "Feishu App Secret",

      Step4Title: "Launch & Verify",
      Step4Sub: "One-click gateway start with automatic health checks.",
      LaunchGateway: "Launch Gateway",
      Launching: "Launching...",
      StartChatting: "Start Chatting",
      CheckGateway: "Gateway process start",
      CheckHealth: "GET /health check",
      CheckChannel: "Channel connection verify",
      CheckModel: "Model API test",
      StatusPass: "PASS",
      StatusChecking: "checking...",
      StatusWaiting: "waiting",
      ReadyTitle: "rsclaw is ready!",
      ReadySub: "Chat endpoint auto-switched to localhost:18888. Click \"Start Chatting\" to begin.",
      Summary: (lang: string, providers: string, channels: string) =>
        `Language: ${lang} | Providers: ${providers} | Channels: ${channels || "none"}`,
    },
  },
};

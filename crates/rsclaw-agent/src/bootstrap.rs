...
// The embedded `tools/` source tree lives at the workspace root, two levels
// above this crate's manifest dir (crates/rsclaw-agent). After the crate-split
// extraction the path is relative to the new crate, not the workspace root.

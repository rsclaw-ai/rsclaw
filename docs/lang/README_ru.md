...
- **Протокол A2A** -- Google A2A v1.0 (межсетевое взаимодействие агентов)
...
Полная документация в [README.md](../../README.md) (中文) или [README_en.md](../../README.md) (English).

## Лицензия

Проект распространяется под двойной лицензией MIT OR Apache-2.0. Подробности см. в [английском README](../../README.md#license).

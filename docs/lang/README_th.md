...
- **โปรโตคอล A2A** -- Google A2A v1.0 (การทำงานร่วมกันของเอเจนต์ข้ามเครือข่าย)
...
โปรเจกต์นี้อยู่ภายใต้ลิขสิทธิ์คู่ MIT OR Apache-2.0 ดูรายละเอียดที่ [README ภาษาอังกฤษ](../../README.md#license)

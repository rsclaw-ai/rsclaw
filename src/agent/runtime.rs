...
use super::context_mgr::{
    ...
    compress_image_for_llm, msg_chars, msg_tokens, strip_old_images,
};
use super::platform::{
    detect_chrome, has_display, is_cliclick_special_key, jpeg_dimensions, map_modifier,
    map_modifier_xdotool, match_skills, powershell_hidden, run_powershell_input, run_subprocess,
    win_map_key, win_mouse_click, win_set_cursor,
};
use super::prompt_builder::{
    build_base_system_prompt, build_help_text_filtered, build_system_prompt, format_duration,
